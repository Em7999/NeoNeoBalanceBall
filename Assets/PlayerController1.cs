...
public class PlayerController1 : MonoBehaviour
{
    ...
    public Sprite[] P1_face;
    // Start is called before the first frame update
    void Start()
    {
        _rig = GetComponent<Rigidbody2D>();
        food_music.playOnAwake = false;
        bullet_music.playOnAwake = false;
    ...
    public void setangle(Vector3 _dir)
    {
        ...
        Vector3 movement = new Vector3(_dir.x, _dir.y+1.8f, 0);
        transform.Translate(movement * speed*0.1f);
    ...
    {
        GetComponent<SpriteRenderer>().sprite = P1_face[i];
    }
}
